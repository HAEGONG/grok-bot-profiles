...
- Link only to related bots that already exist in this repository.
...
- Do not modify files inside existing profile directories.
```
...
7. Related bots exist, raw URLs match the `origin` remote and default branch, and local paths resolve.
